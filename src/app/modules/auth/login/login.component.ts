...
export default class LoginComponent implements OnInit, OnDestroy {
  ...
  private setMetaTags(): void {
    ...
    this.title.setTitle('Iniciar Sesión - Droply.pe | Acceso con WhatsApp');

    // Meta tags para SEO básicos
    this.meta.addTags([
      { name: 'description', content: 'Inicia sesión en Droply.pe fácilmente con tu número de WhatsApp. Sin contraseñas, solo código de verificación.' },
      { name: 'keywords', content: 'login Droply, iniciar sesion whatsapp, acceso droply, ingresar droply' },
      { name: 'robots', content: 'noindex, nofollow' },

      // Canonical URL
      { name: 'canonical', content: 'https://droply.pe/login' },

      // Open Graph Meta Tags básicos
      { property: 'og:title', content: 'Iniciar Sesión - Droply.pe' },
      { property: 'og:description', content: 'Accede a tu cuenta Droply.pe con tu número de WhatsApp' },
      { property: 'og:url', content: 'https://droply.pe/login' },
      ...
      // Schema.org para página de login
      {
        name: 'schema.org', content: JSON.stringify({
          ...
          "@type": "WebPage",
          "name": "Iniciar Sesión",
          "description": "Página de acceso a droply.pe",
          "url": "https://droply.pe/login"
        })
      }
    ]);
  }
