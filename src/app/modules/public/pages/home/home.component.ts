...
export default class HomeComponent implements OnInit {
  ...
  private setMetaTags(): void {
    ...
    this.title.setTitle('droply.pe | Monitorea productos | Compara precios | Encuentra las mejores ofertas');

    // Meta tags para SEO básicos
    this.meta.addTags([
      { name: 'description', content: 'droply.pe - Monitorea tus productos favoritos online y recibe alertas de WhatsApp cuando los precios bajen. Ahorra tiempo y dinero en tus compras online.' },
      ...
      { property: 'og:title', content: 'droply.pe - | Monitorea productos | Compara precios | Encuentra las mejores ofertas' },
      ...
      { property: 'og:image', content: 'https://droply.pe/logo.png' },
      { property: 'og:url', content: 'https://droply.pe/' },
      { property: 'og:type', content: 'website' },

      // Twitter Card Meta Tags
      { name: 'twitter:card', content: 'summary_large_image' },
      { name: 'twitter:title', content: 'droply.pe - | Monitorea productos | Compara precios | Encuentra las mejores ofertas' },
      { name: 'twitter:description', content: 'Monitorea precios online y recibe alertas instantáneas de WhatsApp cuando bajen.' },
      { name: 'twitter:image', content: 'https://droply.pe/logo.png' }
    ]);
  }
